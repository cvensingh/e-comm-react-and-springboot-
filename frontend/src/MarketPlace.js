...
//import { getProducts } from "../src/productService"; // Import API function
import { useNavigate } from "react-router-dom";
import "./MarketPlace.css"; // Ensure correct styling
...
const MarketPlace = () => {
  ...
  // Category Data with Correct Paths
  const categories = [
    { title: "Food Grains",
       description: "Wheat, Rice, Soyabeans, Maize, Arahar.",
        image: "/images/foodGrainsImage.jpg",
         path: "/FoodGrains" },
    { title: "Nuts", 
      description: "Dry Fruits, Almond, Cashew, Apricot.", 
       image: "/images/nutsImage.jpg",
        path: "/nuts" },
    { title: "Vegetables", 
      description: "Green Leafy Vegetables, Onion, Tomato, Potato, Garlic.",
       image: "/images/vegetableImage.jpg", path: "/vegetables" },
    { title: "Fruits",
       description: "Apples, Banana, Mango, Orange, Papaya.",
        image: "/images/fruitImage.jpg", path: "/fruits" },
    { title: "Dairy Products",
       description: "Milk, Cheese, Butter, Yogurt.",
        image: "/images/dairyImage.jpg",
         path: "/DairyProducts" },
    { title: "Spices", 
      description: "Spices, Exotic Herbs, Stems, Flowers, Leaves.",
